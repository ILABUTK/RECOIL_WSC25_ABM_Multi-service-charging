...
# Define experiments with varying wait_thresholds and time_factors
experiments = [
    {"name": "wait_15_time_0.5", "wait_threshold": 15, "time_factor": 0.5},
    {"name": "wait_30_time_0.5", "wait_threshold": 30, "time_factor": 0.5},
    {"name": "wait_45_time_0.5", "wait_threshold": 45, "time_factor": 0.5},
    {"name": "wait_60_time_0.5", "wait_threshold": 60, "time_factor": 0.5},
    {"name": "wait_15_time_1.0", "wait_threshold": 15, "time_factor": 1.0},
    {"name": "wait_30_time_1.0", "wait_threshold": 30, "time_factor": 1.0},
    {"name": "wait_45_time_1.0", "wait_threshold": 45, "time_factor": 1.0},
    {"name": "wait_60_time_1.0", "wait_threshold": 60, "time_factor": 1.0},
    {"name": "wait_15_time_1.5", "wait_threshold": 15, "time_factor": 1.5},
    {"name": "wait_30_time_1.5", "wait_threshold": 30, "time_factor": 1.5},
    {"name": "wait_45_time_1.5", "wait_threshold": 45, "time_factor": 1.5},
    {"name": "wait_60_time_1.5", "wait_threshold": 60, "time_factor": 1.5},
    {"name": "wait_15_time_2", "wait_threshold": 15, "time_factor": 2},
    {"name": "wait_30_time_2", "wait_threshold": 30, "time_factor": 2},
    {"name": "wait_45_time_2", "wait_threshold": 45, "time_factor": 2},
    {"name": "wait_60_time_2", "wait_threshold": 60, "time_factor": 2},
]
...
for exp in experiments:
    ...
    for seed in range(10):
        ...
        model = ChargingStation(
            ...
            wait_threshold=exp["wait_threshold"],
            time_factor=exp["time_factor"]
        )
        for i in range(288):
            model.step(i)
    ...
    all_results.append({
        "Experiment": exp["name"],
        "Wait Threshold (min)": exp["wait_threshold"],
        "Time Factor": exp["time_factor"],
...
# Convert to DataFrame, print, and save
summary_df = pd.DataFrame(all_results)
print(summary_df.to_string(index=False))
summary_df.to_excel("experiment_summary_3.xlsx", index=False)
